        ...
        <div className="flex flex-col w-[643px] items-start gap-[20px] relative">
            ...
            <div className="flex flex-col w-full items-start gap-[7px] relative">
                ...
                <p className="relative">
                    <Tab/>여러 동아리의 개발 프로젝트를 관리하는 PaaS 형태의 통합 인프라입니다. 프로젝트를 개발하는 학생들이 서버 성능이나 관리, 비용 부담 없이 프로젝트를 배포하고 사용할 수 있도록 하는 것이 목적입니다.<br/>
                    <Tab/>현재 5개 동아리에서 개발하는 6개의 서비스, 28개의 프로젝트(56개의 Pod)를 인프라에서 운영 중이며, 교내 선생님과 학생을 포함한 약 250명의 유저가 배포된 서비스를 사용하고 있습니다.
                </p>
                </div>
            ...
            <div className="flex flex-col items-start gap-[9px]">
                ...
                <p className="relative self-stretch">
                <span>
                    <Tab/>다만, 장애가 발생했을 때 지식의 부족으로 바로 대응하지 못하였을 때가 있었다는 점이
                    아쉽습니다. 사용하는 기술에 대한 근본적인 이해나 디버깅 능력이 부족하다면 서버의 불안정 상태가
                    길어져 사용자에게 불편한 경험을 줄 수 있다는 것을 몸소 느꼈습니다. 앞으로는 기술을 도입하거나
                    인프라를 변경할 때 먼저 <b>기술을 충분히 이해하고, 영향받는 부분이 없을지</b> 꼼꼼히 살피며 고려해야겠다고 생각했습니다.
                </span>
                </p>
            </div>
            </div>
