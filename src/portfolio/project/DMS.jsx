            ...
            <p className="relative self-stretch">
                ...
                <div className="ml-[10px]">
                    <Toggle summary="요구사항 수집 및 추가 기능 기획, 문서화" detail={
                        <>
                            프로젝트 요구사항 수집 및 기획 과정을 주도했습니다. 설문조사와 인터뷰를 통해 요구사항을 수집하고 PRD와 기능명세서 등 문서를 작성하여 서비스의 기능을 팀원들과 함께 세밀하게 기획했습니다. <br/> 
                            <Gap/>
                    ...
                    <Toggle summary={<>외부 컨택 → 특정 고등학교에서 한 달간 테스트 운영, 기숙사 관리 업체와의 미팅 및 피드백</>} detail={
                        <>
                            ...
                            기능소개서 및 가이드를 작성하여 대상 고객에 서비스 사용 제안을 보냈습니다.<br/>
                            한 고등학교와 기숙사 관리 업체에 긍정적인 연락을 이었습니다.
                            <Gap/>
            ...
            <p className="relative self-stretch">
                ...
                <div className="ml-[10px]">
                    <Toggle summary="Docker gateway Missing 이슈 해결" detail={
                        <>
                            <Tab/> Spring 서버와 MySQL, Redis를 bridge 도커 네트워크로 연결하고 DB는 해당 내부 ip를 통해서만 통신하도록 하여 DB의 외부 노출을 줄이려 하였습니다. 그러나 구축하던 중, 외부에서 bridge에 연결되어있는 container에 접근할 수 없는 이슈가 발생했습니다.<br/>
                            <code>Docker network inspect</code>로 확인하니 network gateway가 사라진 것을 확인하였습니다.
                            <ModalImage
                                src="/img/description/docker-gateway-missing.png"
                                className="h-[170px] mt-[10px]" open={imageOpen}
                                caption="docker network inspect 결과에 gateway가 없는 모습"
                            />
                            <Tab/> 정확한 원인은 알아내지 못했으나 Docker를 재시작함으로써 해결했습니다. 이 이슈를 통해 통신 문제가 생겼을 때 그 발생 지점을 빠르게 찾아내기 위해선 네트워크에 대한 이해와 디버깅 능력이 중요하다는 것을 느꼈고, network에서 subnet과 gateway의 역할 및 ip 구조에 대해 더욱 이해할 수 있었습니다.
                        </>
                    }/>
