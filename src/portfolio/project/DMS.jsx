...
export const DMS = ({imageOpen}) => {
    return (
        <div className="flex flex-col w-[643px] items-start gap-[15px] relative">
            ...
            <p className="relative self-stretch">
                <Tab/>프로젝트를 성공적으로 진행하기 위해선 팀원 각자가 지향하는 목표가 일치될 수 있도록 이끄는 것이 중요하다는 것을 알았습니다. 리더인 저조차도 진행에 있어 불확실함이 크다고 느꼈기에 구체적인 비전을 제시할 수 없었고, 그것이 팀원들에게도 영향을 준다는 걸 느꼈습니다. 어떻게 해야 분명한 비전을 만들 수 있는지 답을 찾지는 못했지만 좋은 리더가 되기 위해선 더 많은 공부와 경험이 필요하겠다고 생각했습니다.<br />
            </p>
            <p className="relative self-stretch">
                <span>
