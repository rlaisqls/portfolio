        ...
        <div className="flex flex-col w-[643px] items-start gap-[15px] relative">
            ...
            <p className="relative self-stretch">
                ...
                <div className="ml-[10px]">
                    ...
                    <Toggle summary={<>외부 학교 컨택 → 한 고등학교에서 한 달간 테스트 운영,<br/>기숙사 관리 업체와의 미팅 및 피드백</>} detail={
                        <>
            ...
            <p className="relative self-stretch">
                <Tab/>고등학교와 기숙사 관리 업체에 서비스를 운영할 기회가 있었으나, 여러 이유로 인해 좌초된 점이 아쉽습니다. 학생 신분으로 인한 제약 때문에 목표 달성을 위한 대안을 시도하지 못했던 것도 일부 원인이지만 더 근본적인 문제는 잠재적인 문제점에 대해 미리 파악하고 시작하지 않은 점이었다고 생각합니다. 초기 단계에서 여러 시나리오와 문제점을 고려하는 것이 중요하다는 걸 깨달았으며 예상치 못한 어려움에 부딪혔을 때 새로운 방향을 탐색하고 대응할 수 있는 유연성 또한 필요함을 알게 되었습니다.
            </p>
            <p className="relative self-stretch">
