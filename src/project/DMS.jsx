        ...
        <div className="flex flex-col w-[643px] items-start gap-[15px] relative">
            ...
            <p className="relative self-stretch">
                ...
                <div className="ml-[10px]">
                    <Toggle summary="외부 컨택 및 설문조사 진행, 추가 기능 기획" detail={
                        <>
                    ...
                    <Toggle summary="외부 학교 컨택 → 동신과학고등학교에서 한 달간 테스트 운영" detail={
                        <>
                            ...
                            <Tab/>그 결과 개발한 프로젝트를 동신과학고등학교에서 한 달간 테스트 할 수 있었습니다. 하지만 개인정보 관리 문제가 있고 학생 신분인 저희 동아리가 보안 이슈에 대한 책임을 질 수 없다는 점이 문제되어 지속적인 사용은 무산되었습니다.<br/> 
                        </>
                    }/>
                    <Toggle summary="기숙사 관리 업체와의 미팅 및 피드백" detail={
                        <>
                            <Tab/>개인정보 문제를 해결하기 위해선 기숙사 관리 소프트웨어 제작에 대한 수요가 있고 보안을 관리할 수 있는 능력이 있는 기업과 협업하는 것이 방법일 것이라 판단했습니다. 따라서 기업을 대상으로 기능소개서 및 가이드를 이메일로 전송하여 서비스를 홍보하는 전략을 세웠습니다.<br/> 
                            <Tab/>기숙사 관리 서비스를 제공하는 (주)이도의 리브앳디에 성공적인 컨택이 이뤄져 DMS의 기능에 대한 피드백을 받았고, 특정 학교에서 서비스를 운영하는 것에 대한 제의를 받았습니다. 그러나 학교에서 금전적인 문제, 유지보수의 어려움 등을 원인으로 기업과의 협업을 반대하여 성사되지 못했고 현재는 외부 컨택 프로젝트가 종료되었습니다.
                        </>
                    }/>
                </div>
            </p>
            ...
            <div className="flex flex-col items-start gap-[9px]">
            <p className="relative self-stretch">
                <Tab/>PM 역할을 맡아, 다른 학교에 서비스를 실질적으로 적용하는 것을 목표로 홍보와 컨택 작업을 적극적으로 주도하였습니다. 설문조사와 인터뷰를 통해 필요한 요구사항들을 수집하며, 이를 바탕으로 PRD와 기능명세서를 작성하여 팀원들과 함께 서비스의 기능을 세밀하게 기획해 나갔습니다.<br />
            </p>
            <p className="relative self-stretch">
                <Tab/>동신과학고등학교와 기숙사 관리 업체에 서비스를 운영할 기회가 있었으나, 여러 이유로 인해 좌초된 점이 아쉽습니다. 학생 신분으로 인한 제약 때문에 목표 달성을 위한 대안을 시도하지 못했던 것도 일부 원인이지만 더 근본적인 문제는 잠재적인 문제점에 대해 미리 파악하고 시작하지 않은 점이었다고 생각합니다. 초기 단계에서 여러 시나리오와 문제점을 고려하는 것이 중요하다는 걸 깨달았으며 예상치 못한 어려움에 부딪혔을 때 새로운 방향을 탐색하고 대응할 수 있는 유연성 또한 필요함을 알게 되었습니다.
            </p>
            <p className="relative self-stretch">
            ...
            <p className="relative self-stretch">
                <Tab/>프로젝트를 성공적으로 진행하기 위해선 팀원 각자가 지향하는 목표가 일치될 수 있도록 이끄는 것이 중요하다는 것을 알았습니다. 프로젝트를 주도하는 저 조차도 진행에 있어 불확실함이 크다고 느꼈기에 구체적인 목표를 제시할 수 없었고, 그것이 팀원들에게도 영향을 준다는 걸 느꼈습니다. 어떻게 해야 분명한 비전을 만들 수 있는지 답을 찾지는 못했지만 좋은 리더가 되기 위해선 더 많은 공부와 경험이 필요하겠다고 생각했습니다.<br />
            </p>
            <p className="relative self-stretch">
                <span>
