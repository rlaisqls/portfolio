        ...
        <div className="flex flex-col w-[643px] items-start gap-[15px] relative">
            ...
            <p className="relative self-stretch">
                ...
                <div className="ml-[10px]">
                    ...
                    <Toggle summary="외부 학교 컨택 → 한 고등학교에서 한 달간 테스트 운영" detail={
                        <>
                    ...
                    <Toggle summary="기숙사 관리 업체와의 미팅 및 피드백" detail={
                        <>
                            ...
                            <Tab/>기숙사 관리 서비스를 제공하는 한 회사와 성공적인 컨택이 이뤄져 DMS의 기능에 대한 피드백을 받았고, 특정 학교에서 서비스를 운영하는 것에 대한 제의를 받았습니다. 그러나 학교에서 금전적인 문제, 유지보수의 어려움 등을 원인으로 기업과의 협업을 반대하여 성사되지 못했고 현재는 외부 컨택 프로젝트가 종료되었습니다.
                        </>
                    }/>
                </div>
            </p>
